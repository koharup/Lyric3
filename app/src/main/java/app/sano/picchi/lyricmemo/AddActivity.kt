...
class AddActivity : AppCompatActivity() {
    ...
    fun save(title: String, updateDate: String, content: String, word1: String, word2: String) {
    ...
    fun create(view: View) {
        ...
        //出力してみる
        check(title, updateDate, content, word1, word2)

        //保存
        save(title, updateDate, content,word1, word2)
    ...
    fun check(title: String, updateDate: String, content: String, word1: String,word2:String) {
